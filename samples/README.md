...
**Skill menu: [../catalog/frontend/](../catalog/frontend/)** — 28 ready-made
frontend skills (task skills + library-convention skills) to pick from per
repo (adapt placeholders first; install 5–8, prune monthly).
